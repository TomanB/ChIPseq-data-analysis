...
setwd("D:/01_Private Dateien/Biochemie Studium/Masterstudium/01 - Molecular Biosciences - Major Cancer Biology - RKU Heidelberg/4th semester - master thesis/ENCODE_ChIPseq/")
...
# Snyder Stanford convervative IDR peaks example file: ENCFF838NIW.bed <- ChIPseq data of MYC transcription factor in K562 cell line 
...
```{r ChIPseq peak profile, echo=TRUE}
...
fastalist <- readDNAStringSet("D:/01_Private Dateien/Biochemie Studium/Masterstudium/01 - Molecular Biosciences - Major Cancer Biology - RKU Heidelberg/4th semester - master thesis/ENCODE_ChIPseq/ChIP_seq.fasta")
...
ChIP_prom_df <- read_tsv(file = "D:/01_Private Dateien/Biochemie Studium/Masterstudium/01 - Molecular Biosciences - Major Cancer Biology - RKU Heidelberg/4th semester - master thesis/ENCODE_ChIPseq/ChIPseq_prom_df.txt")
...
head(pwm_library_dt)
```
# batplot of pearson correlation values of known motifs from JASPAR2018 data
```{r PWM alignment barplot, echo=TRUE}
